...
import { ArrayPairsStoreManager } from "../../../src/core/store/array-pairs-store-manager.js";
...
before(() => {
    ...
    manager = new ArrayPairsStoreManager(arrayPairs);
...
describe("ArrayPairsStoreManager", () => {
